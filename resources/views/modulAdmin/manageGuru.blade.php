...
<body class="bg-slate-100 text-slate-800 font-sans antialiased selection:bg-indigo-500 selection:text-white pb-28">
    ...
    <div class="mx-auto flex min-h-screen w-full max-w-7xl flex-col space-y-5 bg-slate-100 p-4 sm:p-6 md:space-y-8 md:p-8 lg:px-12">
        ...
        <div class="bg-white rounded-2xl border-2 border-slate-300 shadow-sm p-3.5 flex items-center space-x-3">
            ...
            <input type="text" placeholder="Cari nama guru atau NIP..." class="w-full bg-transparent text-xs sm:text-sm font-semibold text-slate-900 placeholder:text-slate-400 focus:outline-none">
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="bg-white rounded-2xl border-2 border-slate-200 shadow-sm p-4.5 flex items-center justify-between space-x-3 hover:border-indigo-600 transition-all">
                <div class="flex items-center space-x-3.5 min-w-0">
                    <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150" alt="Kak Dr. Lutfi" class="w-12 h-12 rounded-xl object-cover flex-shrink-0 shadow-sm border border-slate-300">
                    <div class="space-y-0.5 truncate">
                        <h3 class="text-xs sm:text-sm font-extrabold text-slate-900 truncate">Kak Dr. Lutfi</h3>
                        <p class="text-xs text-slate-600 font-semibold truncate">NIP: 19820412200 • Fisika</p>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-2xl border-2 border-slate-200 shadow-sm p-4.5 flex items-center justify-between space-x-3 hover:border-indigo-600 transition-all">
                <div class="flex items-center space-x-3.5 min-w-0">
                    <img src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150" alt="Kak Sherly M.Si" class="w-12 h-12 rounded-xl object-cover flex-shrink-0 shadow-sm border border-slate-300">
                    <div class="space-y-0.5 truncate">
                        <h3 class="text-xs sm:text-sm font-extrabold text-slate-900 truncate">Kak Sherly M.Si</h3>
                        <p class="text-xs text-slate-600 font-semibold truncate">NIP: 19890311200 • Matematika</p>
                    </div>
                </div>
                <span class="px-3 py-1 bg-emerald-100 border border-emerald-300 text-emerald-800 text-xs font-extrabold rounded-lg flex-shrink-0">Aktif</span>
            </div>
            ...
            <div class="bg-white rounded-2xl border-2 border-slate-200 shadow-sm p-4.5 flex items-center justify-between space-x-3 hover:border-indigo-600 transition-all">
                <div class="flex items-center space-x-3.5 min-w-0">
                    <img src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150" alt="Kak Prof. Handoko" class="w-12 h-12 rounded-xl object-cover flex-shrink-0 shadow-sm border border-slate-300">
                    <div class="space-y-0.5 truncate">
                        <h3 class="text-xs sm:text-sm font-extrabold text-slate-900 truncate">Kak Prof. Handoko</h3>
                        <p class="text-xs text-slate-600 font-semibold truncate">NIP: 19721014199 • Kimia</p>
                    </div>
                </div>
                <span class="px-3 py-1 bg-emerald-100 border border-emerald-300 text-emerald-800 text-xs font-extrabold rounded-lg flex-shrink-0">Aktif</span>
            </div>
            ...
            <div class="bg-white rounded-2xl border-2 border-slate-200 shadow-sm p-4.5 flex items-center justify-between space-x-3 hover:border-indigo-600 transition-all">
                <div class="flex items-center space-x-3.5 min-w-0">
                    <img src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150" alt="Bpk. Ahmad Fauzi" class="w-12 h-12 rounded-xl object-cover flex-shrink-0 shadow-sm border border-slate-300">
                    <div class="space-y-0.5 truncate">
                        <h3 class="text-xs sm:text-sm font-extrabold text-slate-900 truncate">Bpk. Ahmad Fauzi</h3>
                        <p class="text-xs text-slate-600 font-semibold truncate">NIP: 19900824201 • Bahasa Indonesia</p>
                    </div>
                </div>
