...
<body class="bg-[#F8FAFC] text-slate-800 font-sans antialiased selection:bg-indigo-500 selection:text-white pb-28">
    ...
    <div class="mx-auto flex min-h-screen w-full max-w-md flex-col space-y-5 bg-[#F8FAFC] p-4 sm:p-6 md:max-w-7xl md:space-y-8 md:p-8 lg:px-12">
        ...
        <!-- Header Halaman -->
        <div class="pt-2">
            <h1 class="text-xl sm:text-2xl font-black text-slate-900 tracking-tight">Manajemen Pembayaran</h1>
        </div>
        ...
        <div class="bg-white rounded-2xl border border-slate-200/80 shadow-sm p-3.5 flex items-center space-x-3">
            ...
            <input type="text" placeholder="Cari nama mahasiswa atau No. Invoice..." class="w-full bg-transparent text-xs font-bold text-slate-800 placeholder:text-slate-400 focus:outline-none">
        </div>
        ...
        <div class="flex items-center space-x-2 overflow-x-auto no-scrollbar">
            ...
            <button class="px-4 py-2 bg-white border border-slate-200/80 text-slate-600 font-bold text-xs rounded-full hover:bg-slate-50 flex-shrink-0 transition-all">Lunas</button>
            <button class="px-4 py-2 bg-white border border-slate-200/80 text-slate-600 font-bold text-xs rounded-full hover:bg-slate-50 flex-shrink-0 transition-all">Belum Lunas</button>
        </div>
        ...
        <div class="space-y-3">
                ...
                <div class="flex items-center space-x-3.5 min-w-0">
                    ...
                    <div class="space-y-0.5 truncate">
                        <div class="flex items-center space-x-2">
                            <h3 class="text-xs sm:text-sm font-black text-slate-900 truncate">Bintang Cakrawala</h3>
                            <span class="text-xs font-black text-indigo-600">Rp 1.500.000</span>
                        </div>
                        <p class="text-[10px] text-slate-400 font-medium truncate">#INV-2026-0012 • SPP Semester 1 (24 Jul 2026)</p>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-3xl border border-slate-100 shadow-sm p-4 flex items-center justify-between space-x-3">
                <div class="flex items-center space-x-3.5 min-w-0">
                    ...
                    <div class="space-y-0.5 truncate">
                        <div class="flex items-center space-x-2">
                            <h3 class="text-xs sm:text-sm font-black text-slate-900 truncate">Siti Aminah</h3>
                            <span class="text-xs font-black text-indigo-600">Rp 350.000</span>
                        </div>
                        <p class="text-[10px] text-slate-400 font-medium truncate">#INV-2026-0015 • Uang Praktikum (18 Jul 2026)</p>
                    </div>
                </div>
                <span class="px-2.5 py-1 bg-emerald-50 text-emerald-600 text-[10px] font-black rounded-full flex-shrink-0">Lunas</span>
            </div>
            ...
            <div class="bg-white rounded-3xl border border-slate-100 shadow-sm p-4 flex items-center justify-between space-x-3">
                <div class="flex items-center space-x-3.5 min-w-0">
                    <div class="w-11 h-11 rounded-2xl bg-amber-50 text-amber-600 flex items-center justify-center flex-shrink-0 font-bold shadow-sm">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"/></svg>
                    </div>
                    <div class="space-y-0.5 truncate">
                        <div class="flex items-center space-x-2">
                            <h3 class="text-xs sm:text-sm font-black text-slate-900 truncate">Rian Hidayat</h3>
                            <span class="text-xs font-black text-amber-600">Rp 1.500.000</span>
                        </div>
                        <p class="text-[10px] text-slate-400 font-medium truncate">#INV-2026-0021 • SPP Semester 1 (20 Jul 2026)</p>
                    </div>
                </div>
                <span class="px-2.5 py-1 bg-amber-50 text-amber-600 text-[10px] font-black rounded-full flex-shrink-0">Belum Lunas</span>
            </div>
