...
<body class="bg-[#F8FAFC] text-slate-800 font-sans antialiased selection:bg-indigo-500 selection:text-white pb-28">
    ...
    <div class="mx-auto flex min-h-screen w-full max-w-md flex-col space-y-5 bg-[#F8FAFC] p-4 sm:p-6 md:max-w-7xl md:space-y-8 md:p-8 lg:px-12">
        ...
        <!-- Header Halaman -->
        <div class="pt-2">
            <h1 class="text-xl sm:text-2xl font-black text-slate-900 tracking-tight">Manajemen Siswa</h1>
        </div>
        ...
        <div class="bg-white rounded-2xl border border-slate-200/80 shadow-sm p-3.5 flex items-center space-x-3">
            ...
            <input type="text" placeholder="Cari nama mahasiswa atau NISN..." class="w-full bg-transparent text-xs font-bold text-slate-800 placeholder:text-slate-400 focus:outline-none">
        </div>
        ...
        <div class="space-y-3">
            ...
            <div class="bg-white rounded-3xl border border-slate-100 shadow-sm p-4 flex items-center justify-between space-x-3">
                <div class="flex items-center space-x-3.5 min-w-0">
                    <img src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150" alt="Budi Santoso" class="w-12 h-12 rounded-2xl object-cover flex-shrink-0 shadow-sm">
                    <div class="space-y-0.5 truncate">
                        <h3 class="text-xs sm:text-sm font-black text-slate-900 truncate">Budi Santoso</h3>
                        <p class="text-[10px] text-slate-400 font-medium truncate">NISN: 0082718291 • Kelas XII - IPA 2</p>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-3xl border border-slate-100 shadow-sm p-4 flex items-center justify-between space-x-3">
                <div class="flex items-center space-x-3.5 min-w-0">
                    <img src="https://images.unsplash.com/photo-1517841905240-472988babdf9?w=150" alt="Siti Aminah" class="w-12 h-12 rounded-2xl object-cover flex-shrink-0 shadow-sm">
                    <div class="space-y-0.5 truncate">
                        <h3 class="text-xs sm:text-sm font-black text-slate-900 truncate">Siti Aminah</h3>
                        <p class="text-[10px] text-slate-400 font-medium truncate">NISN: 0082718105 • Kelas XI - IPS 1</p>
                    </div>
                </div>
                <span class="px-2.5 py-1 bg-emerald-50 text-emerald-600 text-[10px] font-black rounded-full flex-shrink-0">Aktif</span>
            </div>
            ...
            <div class="bg-white rounded-3xl border border-slate-100 shadow-sm p-4 flex items-center justify-between space-x-3">
                <div class="flex items-center space-x-3.5 min-w-0">
                    <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150" alt="Rian Hidayat" class="w-12 h-12 rounded-2xl object-cover flex-shrink-0 shadow-sm">
                    <div class="space-y-0.5 truncate">
                        <h3 class="text-xs sm:text-sm font-black text-slate-900 truncate">Rian Hidayat</h3>
                        <p class="text-[10px] text-slate-400 font-medium truncate">NISN: 0082718304 • Kelas XII - IPA 1</p>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-3xl border border-slate-100 shadow-sm p-4 flex items-center justify-between space-x-3">
                <div class="flex items-center space-x-3.5 min-w-0">
                    <img src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=150" alt="Dewi Lestari" class="w-12 h-12 rounded-2xl object-cover flex-shrink-0 shadow-sm">
                    <div class="space-y-0.5 truncate">
                        <h3 class="text-xs sm:text-sm font-black text-slate-900 truncate">Dewi Lestari</h3>
                        <p class="text-[10px] text-slate-400 font-medium truncate">NISN: 0082718159 • Kelas XII - IPS 3</p>
                    </div>
                </div>
                <span class="px-2.5 py-1 bg-emerald-50 text-emerald-600 text-[10px] font-black rounded-full flex-shrink-0">Aktif</span>
            </div>
