            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                ...
                <div class="bg-white p-5 rounded-2xl border-2 border-slate-200 shadow-sm flex flex-col justify-between space-y-3">
                    ...
                    <div class="flex items-baseline space-x-2">
                        <span class="text-3xl font-extrabold text-slate-900">{{ number_format($avgScore ?? 0, 1) }}</span>
                        @php
                            $score = $avgScore ?? 0;
                            $gradeLetter = $score >= 85 ? 'A' : ($score >= 75 ? 'B' : 'C');
                        @endphp
                        <span class="px-2 py-0.5 {{ $score >= 75 ? 'bg-emerald-100 border-emerald-300 text-emerald-800' : 'bg-rose-100 border-rose-300 text-rose-800' }} border font-extrabold text-xs rounded-md">{{ $gradeLetter }}</span>
                    </div>
                </div>
                ...
                <div class="bg-white p-5 rounded-2xl border-2 border-slate-200 shadow-sm flex flex-col justify-between space-y-3">
                    ...
                    <div class="flex items-baseline space-x-1.5">
                        <span class="text-3xl font-extrabold text-slate-900">{{ $materialsCount ?? 0 }}</span>
                ...
                <div class="bg-white p-5 rounded-2xl border-2 border-slate-200 shadow-sm flex flex-col justify-between space-y-3">
                    ...
                    <div class="flex items-baseline space-x-2">
                        <span class="text-3xl font-extrabold text-slate-900">{{ $completedTasksCount ?? 0 }}</span>
                ...
                <div class="bg-white p-5 rounded-2xl border-2 border-slate-200 shadow-sm flex flex-col justify-between space-y-3">
                    <span class="text-xs font-extrabold text-slate-500 uppercase tracking-wider">Peringkat Kelas</span>
