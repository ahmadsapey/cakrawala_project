	...
	<div class="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6">
		...
		<nav class="ml-auto flex items-center gap-1" aria-label="Navigasi guru">
			...
			<details class="group relative">
				...
				<div class="absolute right-0 mt-2 w-52 rounded-2xl border border-slate-100 bg-white p-2 shadow-xl shadow-indigo-100/50">
					<a href="{{ route('guru.koreksi.kuis') }}" class="flex items-center justify-between rounded-xl px-3 py-2.5 text-xs font-semibold text-slate-600 transition-colors hover:bg-indigo-50 hover:text-indigo-600">
						<span>Koreksi Kuis</span><span class="text-[10px] text-slate-400">Kuis</span>
					</a>
					<a href="{{ route('guru.koreksi.tugas') }}" class="flex items-center justify-between rounded-xl px-3 py-2.5 text-xs font-semibold text-slate-600 transition-colors hover:bg-indigo-50 hover:text-indigo-600">
						<span>Koreksi Tugas</span><span class="text-[10px] text-slate-400">Tugas</span>
					</a>
				</div>
			</details>
		</nav>
